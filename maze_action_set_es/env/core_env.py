"""Contains the CoreEnv for grid2op."""
...
from maze_action_set_es.env.events import ActionEvents, GridEvents, RewardEvents
from maze_action_set_es.env.kpi_calculator import Grid2OpKpiCalculator
from maze_action_set_es.env.l2rpn_renderer import L2RPNRenderer
    ...
    def _init_env(self, power_grid: Union[str, grid2op.Environment.Environment], difficulty: Union[int, str]) -> None:
        ...
        if isinstance(power_grid, str):
            ...
            try:
                ...
                backend = {'backend': LightSimBackend()}
            except ImportError:
